...
export const LOGO = 'https://assets.dianisa.com/media/2024/05/Logo-Universitas-Sulawesi-Barat-Dianisa.com_.png'
...
export function logo(size='h-14 w-14'){
  return `<div class="simasi-logo-frame ${size} shrink-0 rounded-2xl border border-slate-200"><img src="${LOGO}" alt="Logo Universitas Sulawesi Barat"></div>`
}
